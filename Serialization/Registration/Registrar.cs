...
// <copyright file="Registrar.cs" company="Edgerunner.org">
...
namespace Org.Edgerunner.DotSerialize.Serialization.Registration
{
   ...
   {
      /// <summary>
      /// Initializes a new instance of the <see cref="Registrar{T}"/> class. 
      ...
      {
         return
            new RegistrarBinding<TImplementation>(CurrentSerializer.RegisterTypeSerializer(typeof(ITypeSerializer<T>), 
